...
export const LoginView: React.FC = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md bg-white/70 backdrop-blur-md border border-slate-100/50 rounded-3xl p-6 sm:p-8 shadow-2xl relative z-10 text-center flex flex-col justify-between">
        ...
        {/* Google Sign-In Button (moved below the Sign In / signup form) */}
        <div className="relative mt-5">
          <button
            ...
            className="w-full flex items-center justify-center gap-3 py-2.5 px-4 bg-white hover:bg-slate-50 border border-slate-200 rounded-xl font-semibold text-sm text-slate-700 shadow-sm transition-all duration-200 disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {googleLoading ? (
          ...
          <span className="absolute -top-2 right-4 px-2 py-0.5 bg-indigo-600 text-white rounded-full text-[9px] font-bold tracking-wide shadow-sm pointer-events-none select-none uppercase">
            Recommended
          </span>
        </div>
